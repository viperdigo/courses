...
import br.com.alura.financask.extension.limiteEmAte
...
class ListaTransacoesAdapter(private val transacoes: List<Transacao>,
    ...
    private val limiteDeCategoria = 14
    ...
    private fun adcionaData(viewCriada: View, transacao: Transacao) {
